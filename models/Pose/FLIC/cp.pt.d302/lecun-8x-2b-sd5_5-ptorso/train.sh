...
# models/Pose/FLIC/cp.pt.d302/lecun-8x-2b-sd5_5-ptorso/
ProtosDir="models/Pose/"
SubProtosDir="FLIC/cp.pt.d302/"
ExperName="lecun-8x-2b-sd5_5-ptorso/"
ExperPath=$ProtosDir$SubProtosDir$ExperName
mkdir -p $ExperPath
# models/Pose/FLIC/cp.pt.d302/lecun-8x-2b-sd5_5-ptorso/solver.prototxt
solver_proto="solver.prototxt"
solver_proto=$ExperPath$solver_proto
echo $solver_proto
# ../asserts/models/Pose/FLIC/cp.pt.d302/lecun-8x-2b-sd5_5-ptorso/
ModelsDir="../asserts/"
ModelsDir=$ModelsDir$ExperPath
mkdir -p $ModelsDir
# ../asserts/models/Pose/FLIC/cp.pt.d302/lecun-8x-2b-sd5_5-ptorso/models/
model_path="models/"
model_path=$ModelsDir$model_path
mkdir -p $model_path
echo $model_path
# ../asserts/models/Pose/FLIC/cp.pt.d302/lecun-8x-2b-sd5_5-ptorso/log/
log_path="log/"
