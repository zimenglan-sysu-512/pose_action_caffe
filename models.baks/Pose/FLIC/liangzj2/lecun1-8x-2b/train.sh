...
# models/Pose/FLIC/liangzj2/lecun1-8x-2b/
ProtosDir="models/Pose/"
SubProtosDir="FLIC/liangzj2/"
ExperName="lecun1-8x-2b/"
ExperPath=$ProtosDir$SubProtosDir$ExperName
mkdir -p $ExperPath
# models/Pose/FLIC/liangzj2/lecun1-8x-2b/solver.prototxt
solver_proto="solver.prototxt"
solver_proto=$ExperPath$solver_proto
echo $solver_proto
# ../asserts/models/Pose/FLIC/liangzj2/lecun1-8x-2b/
ModelsDir="../asserts/"
ModelsDir=$ModelsDir$ExperPath
mkdir -p $ModelsDir
# ../asserts/models/Pose/FLIC/liangzj2/lecun1-8x-2b/models/
model_path="models/"
model_path=$ModelsDir$model_path
mkdir -p $model_path
echo $model_path
# ../asserts/models/Pose/FLIC/liangzj2/lecun1-8x-2b/log/
log_path="log/"
