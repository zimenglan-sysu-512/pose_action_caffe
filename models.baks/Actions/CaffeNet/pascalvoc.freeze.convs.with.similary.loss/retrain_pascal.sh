...
PROTODIR="models/Actions/CaffeNet/pascalvoc.freeze.convs.with.similary.loss/"
PROTODIR=$TOOLSDIR$PROTODIR
solvername="pascal_action_solver.prototxt"
solverpath=$PROTODIR$solvername

MODELDIR="action_output/PascalVoc2012/rcnn_PascalVoc2012_train/caffenet.pascalvoc.freeze.convs.with.similary.loss/"
weightsname="caffenet_pascal_action_iter_38000.caffemodel"
...
exper_name="caffenet.pascalvoc.freeze.convs.with.similary.loss/"
re_iter="20000"
