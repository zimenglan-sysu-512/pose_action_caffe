...
# models/Pose/Kinect2/d302/lecun-8x-2b-sd5_5-tmarks-refine/
ProtosDir="models/Pose/"
SubProtosDir="Kinect2/d302/"
ExperName="lecun-8x-2b-sd5_5-tmarks-refine/"
ExperPath=$ProtosDir$SubProtosDir$ExperName
mkdir -p $ExperPath

# models/Pose/Kinect2/d302/lecun-8x-2b-sd5_5-tmarks-refine/solver.prototxt
solver_proto="solver_all.prototxt"
solver_proto=$ExperPath$solver_proto
echo $solver_proto

# ../asserts/models/Pose/Kinect2/d302/lecun-8x-2b-sd5_5-tmarks-refine/
ModelsDir="../asserts/"
ModelsDir=$ModelsDir$ExperPath
mkdir -p $ModelsDir

# ../asserts/models/Pose/Kinect2/d302/lecun-8x-2b-sd5_5-tmarks-refine/models/
model_path="models/"
model_path=$ModelsDir$model_path
mkdir -p $model_path
echo $model_path

# ../asserts/models/Pose/Kinect2/d302/lecun-8x-2b-sd5_5-tmarks-refine/log/
log_path="log/"
