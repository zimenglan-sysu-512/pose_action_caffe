...
# models/Pose/FLIC/cp.pt.d302/lecun-8x-2b-sd5_5-tmarks_output_dependent/
...
mkdir -p $ExperPath
# models/Pose/FLIC/cp.pt.d302/lecun-8x-2b-sd5_5-tmarks_output_dependent/s4_solver.pt
solver_proto="s4_solver.pt"
solver_proto=$ExperPath$solver_proto
echo $solver_proto
# ../asserts/models/Pose/FLIC/cp.pt.d302/lecun-8x-2b-sd5_5-tmarks_output_dependent/
ModelsDir="../asserts/"
ModelsDir=$ModelsDir$ExperPath
mkdir -p $ModelsDir
# ../asserts/models/Pose/FLIC/cp.pt.d302/lecun-8x-2b-sd5_5-tmarks_output_dependent/s4_models/
model_path="s4_models/"
model_path=$ModelsDir$model_path
mkdir -p $model_path
echo $model_path
# ../asserts/models/Pose/FLIC/cp.pt.d302/lecun-8x-2b-sd5_5-tmarks_output_dependent/s4_log/
log_path="s4_log/"
