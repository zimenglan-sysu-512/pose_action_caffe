...
# pts/flic/ddk/fusnet_tmask_2b/solver.pt
solver_pt="solver.pt"
solver_pt=$exper_path$solver_pt
echo "\n" $solver_pt "\n"

# ../asserts/pts/flic/ddk/fusnet_tmask_2b/
model_dire="../asserts/"
model_dire=$model_dire$exper_path
mkdir -p $model_dire

# ../asserts/pts/flic/ddk/fusnet_tmask_2b/models/
model_path="models/"
model_path=$model_dire$model_path
mkdir -p $model_path
echo $model_path

# ../asserts/pts/flic/ddk/fusnet_tmask_2b/log/
log_path="log/"
