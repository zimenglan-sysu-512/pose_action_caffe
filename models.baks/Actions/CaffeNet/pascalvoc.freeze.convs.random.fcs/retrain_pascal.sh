...
MODELDIR="action_output/PascalVoc2012/rcnn_PascalVoc2012_train/caffenet.pascalvoc.freeze.convs.random.fcs/"
weightsname="caffenet_pascal_action_iter_20000.caffemodel"
...
log_filename=$log_path/$imdbname/$exper_name/$cur_file_prefix$cur_log_filename.log
