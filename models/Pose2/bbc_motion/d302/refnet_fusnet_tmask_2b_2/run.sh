...
# models/Pose2/bbc_motion/d302/refnet_fusnet_tmask_2b_2/
...
# models/Pose2/bbc_motion/d302/refnet_fusnet_tmask_2b_2/solver.pt
solver_pt="solver.pt"
solver_pt=$exper_path$solver_pt
echo "\n" $solver_pt "\n"

# ../asserts/models/Pose2/bbc_motion/d302/refnet_fusnet_tmask_2b_2/
model_dire="../asserts/"
model_dire=$model_dire$exper_path
mkdir -p $model_dire

# ../asserts/models/Pose2/bbc_motion/d302/refnet_fusnet_tmask_2b_2/models/
model_path="models/"
model_path=$model_dire$model_path
mkdir -p $model_path
echo $model_path

# ../asserts/models/Pose2/bbc_motion/d302/refnet_fusnet_tmask_2b_2/log/
log_path="log/"
