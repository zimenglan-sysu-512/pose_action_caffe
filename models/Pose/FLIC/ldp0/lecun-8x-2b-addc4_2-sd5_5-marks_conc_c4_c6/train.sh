...
# models/Pose/FLIC/ldp0/lecun-8x-2b-addc4_2-sd5_5-marks_conc_c4_c6/
ProtosDir="models/Pose/"
SubProtosDir="FLIC/ldp0/"
ExperName="lecun-8x-2b-addc4_2-sd5_5-marks_conc_c4_c6/"
ExperPath=$ProtosDir$SubProtosDir$ExperName
mkdir -p $ExperPath
# models/Pose/FLIC/ldp0/lecun-8x-2b-addc4_2-sd5_5-marks_conc_c4_c6/solver.prototxt
solver_proto="solver.prototxt"
solver_proto=$ExperPath$solver_proto
echo $solver_proto
# ../asserts/models/Pose/FLIC/ldp0/lecun-8x-2b-addc4_2-sd5_5-marks_conc_c4_c6/
ModelsDir="../asserts/"
ModelsDir=$ModelsDir$ExperPath
mkdir -p $ModelsDir
# ../asserts/models/Pose/FLIC/ldp0/lecun-8x-2b-addc4_2-sd5_5-marks_conc_c4_c6/models/
model_path="models/"
model_path=$ModelsDir$model_path
mkdir -p $model_path
echo $model_path
# ../asserts/models/Pose/FLIC/ldp0/lecun-8x-2b-addc4_2-sd5_5-marks_conc_c4_c6/log/
log_path="log/"
