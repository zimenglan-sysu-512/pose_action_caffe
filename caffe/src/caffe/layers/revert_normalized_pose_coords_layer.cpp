...
void RevertNormalizedPoseCoordsLayer<Dtype>::LayerSetUp(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void RevertNormalizedPoseCoordsLayer<Dtype>::Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) 
{
...
template <typename Dtype>
void RevertNormalizedPoseCoordsLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) 
{
...
template <typename Dtype>
void RevertNormalizedPoseCoordsLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
STUB_GPU(RevertNormalizedPoseCoordsLayer);
#endif

INSTANTIATE_CLASS(RevertNormalizedPoseCoordsLayer);
REGISTER_LAYER_CLASS(RevertNormalizedPoseCoords);
