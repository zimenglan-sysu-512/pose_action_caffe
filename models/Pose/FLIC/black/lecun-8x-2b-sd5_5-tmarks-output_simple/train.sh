...
# models/Pose/FLIC/lecun-8x-2b-sd5_5-tmarks-output_simple/
ProtosDir="models/Pose/"
SubProtosDir="FLIC/black/"
ExperName="lecun-8x-2b-sd5_5-tmarks-output_simple/"
ExperPath=$ProtosDir$SubProtosDir$ExperName
mkdir -p $ExperPath
# models/Pose/FLIC/lecun-8x-2b-sd5_5-tmarks-output_simple/solver.pt
solver_proto="solver.pt"
solver_proto=$ExperPath$solver_proto
echo $solver_proto
# ../asserts/models/Pose/FLIC/lecun-8x-2b-sd5_5-tmarks-output_simple/
ModelsDir="../asserts/"
ModelsDir=$ModelsDir$ExperPath
mkdir -p $ModelsDir
# ../asserts/models/Pose/FLIC/lecun-8x-2b-sd5_5-tmarks-output_simple/models/
model_path="models/"
model_path=$ModelsDir$model_path
mkdir -p $model_path
echo $model_path
# ../asserts/models/Pose/FLIC/lecun-8x-2b-sd5_5-tmarks-output_simple/log/
log_path="log/"
