...
# models/Pose/FLIC/black/lecun-8x-2b-sd5_5-marks-pmask/
...
mkdir -p $ExperPath
# models/Pose/FLIC/black/lecun-8x-2b-sd5_5-marks-pmask/solver.prototxt
solver_proto="solver.prototxt"
solver_proto=$ExperPath$solver_proto
echo $solver_proto
# ../asserts/models/Pose/FLIC/black/lecun-8x-2b-sd5_5-marks-pmask/
ModelsDir="../asserts/"
ModelsDir=$ModelsDir$ExperPath
mkdir -p $ModelsDir
# ../asserts/models/Pose/FLIC/black/lecun-8x-2b-sd5_5-marks-pmask/models/
model_path="models/"
model_path=$ModelsDir$model_path
mkdir -p $model_path
echo $model_path
# ../asserts/models/Pose/FLIC/black/lecun-8x-2b-sd5_5-marks-pmask/log/
log_path="log/"
