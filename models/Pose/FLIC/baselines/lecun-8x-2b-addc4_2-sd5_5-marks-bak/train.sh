...
# models/Pose/FLIC/baselines/lecun-8x-2b-addc4_2-sd5_5-marks/
ProtosDir="models/Pose/"
SubProtosDir="FLIC/baselines/"
ExperName="lecun-8x-2b-addc4_2-sd5_5-marks/"
ExperPath=$ProtosDir$SubProtosDir$ExperName
mkdir -p $ExperPath
# models/Pose/FLIC/baselines/lecun-8x-2b-addc4_2-sd5_5-marks/solver.prototxt
solver_proto="solver.prototxt"
solver_proto=$ExperPath$solver_proto
echo $solver_proto
# ../asserts/models/Pose/FLIC/baselines/lecun-8x-2b-addc4_2-sd5_5-marks/
ModelsDir="../asserts/"
ModelsDir=$ModelsDir$ExperPath
mkdir -p $ModelsDir
# ../asserts/models/Pose/FLIC/baselines/lecun-8x-2b-addc4_2-sd5_5-marks/models/
model_path="models/"
model_path=$ModelsDir$model_path
mkdir -p $model_path
echo $model_path
# ../asserts/models/Pose/FLIC/baselines/lecun-8x-2b-addc4_2-sd5_5-marks/log/
log_path="log/"
