...
# models/Pose/Kinect2/ldp0/lecun-8x-2b-addc4_2-sd5_5-marks-refined/
...
# models/Pose/Kinect2/ldp0/lecun-8x-2b-addc4_2-sd5_5-marks-refined/solver.prototxt
solver_proto="solver.prototxt"
solver_proto=$ExperPath$solver_proto
echo $solver_proto

# ../asserts/models/Pose/Kinect2/ldp0/lecun-8x-2b-addc4_2-sd5_5-marks-refined/
ModelsDir="../asserts/"
ModelsDir=$ModelsDir$ExperPath
mkdir -p $ModelsDir

# ../asserts/models/Pose/Kinect2/ldp0/lecun-8x-2b-addc4_2-sd5_5-marks-refined/models/
model_path="models/"
model_path=$ModelsDir$model_path
mkdir -p $model_path
echo $model_path

# ../asserts/models/Pose/Kinect2/ldp0/lecun-8x-2b-addc4_2-sd5_5-marks-refined/log/
log_path="log/"
