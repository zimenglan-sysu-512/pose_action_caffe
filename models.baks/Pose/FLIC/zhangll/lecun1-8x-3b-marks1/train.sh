...
# models/Pose/FLIC/zhangll/lecun1-8x-3b-marks1/
ProtosDir="models/Pose/"
SubProtosDir="FLIC/zhangll/"
ExperName="lecun1-8x-3b-marks1/"
ExperPath=$ProtosDir$SubProtosDir$ExperName
mkdir -p $ExperPath
# models/Pose/FLIC/zhangll/lecun1-8x-3b-marks1/solver.prototxt
solver_proto="solver.prototxt"
solver_proto=$ExperPath$solver_proto
echo $solver_proto
# ../asserts/models/Pose/FLIC/zhangll/lecun1-8x-3b-marks1/
ModelsDir="../asserts/"
ModelsDir=$ModelsDir$ExperPath
mkdir -p $ModelsDir
# ../asserts/models/Pose/FLIC/zhangll/lecun1-8x-3b-marks1/models/
model_path="models/"
model_path=$ModelsDir$model_path
mkdir -p $model_path
echo $model_path
# ../asserts/models/Pose/FLIC/zhangll/lecun1-8x-3b-marks1/log/
log_path="log/"
