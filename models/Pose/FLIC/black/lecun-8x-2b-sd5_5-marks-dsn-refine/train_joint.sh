...
# models/Pose/FLIC/black/lecun-8x-2b-sd5_5-marks-dsn-refine/
ProtosDir="models/Pose/"
SubProtosDir="FLIC/black/"
ExperName="lecun-8x-2b-sd5_5-marks-dsn-refine/"
ExperPath=$ProtosDir$SubProtosDir$ExperName
mkdir -p $ExperPath
# models/Pose/FLIC/black/lecun-8x-2b-sd5_5-marks-dsn-refine/solver_joint.prototxt
solver_joint_proto="solver_joint.prototxt"
solver_joint_proto=$ExperPath$solver_joint_proto
echo $solver_joint_proto
# ../asserts/models/Pose/FLIC/black/lecun-8x-2b-sd5_5-marks-dsn-refine/
ModelsDir="../asserts/"
ModelsDir=$ModelsDir$ExperPath
mkdir -p $ModelsDir
# ../asserts/models/Pose/FLIC/black/lecun-8x-2b-sd5_5-marks-dsn-refine/models.joint/
model_path="models.joint/"
model_path=$ModelsDir$model_path
mkdir -p $model_path
echo $model_path
# ../asserts/models/Pose/FLIC/black/lecun-8x-2b-sd5_5-marks-dsn-refine/log/
log_path="log/"
