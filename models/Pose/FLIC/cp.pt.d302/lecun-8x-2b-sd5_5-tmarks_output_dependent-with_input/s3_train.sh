...
mkdir -p $ExperPath
# models/Pose/FLIC/cp.pt.d302/lecun-8x-2b-sd5_5-tmarks_output_dependent-with_input/s3_solver.pt
...
mkdir -p $ModelsDir
# ../asserts/models/Pose/FLIC/cp.pt.d302/lecun-8x-2b-sd5_5-tmarks_output_dependent-with_input/s3_models/
model_path="s3_models/"
model_path=$ModelsDir$model_path
mkdir -p $model_path
echo $model_path
# ../asserts/models/Pose/FLIC/cp.pt.d302/lecun-8x-2b-sd5_5-tmarks_output_dependent-with_input/s3_log/
log_path="s3_log/"
