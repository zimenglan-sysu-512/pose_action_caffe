...
# models/Pose/FLIC/liangzj/lecun1-8x-2b-marks/
ProtosDir="models/Pose/"
SubProtosDir="FLIC/liangzj/"
ExperName="lecun1-8x-2b-marks/"
ExperPath=$ProtosDir$SubProtosDir$ExperName
mkdir -p $ExperPath
# models/Pose/FLIC/liangzj/lecun1-8x-2b-marks/solver.prototxt
solver_proto="solver.prototxt"
solver_proto=$ExperPath$solver_proto
echo $solver_proto
# ../asserts/models/Pose/FLIC/liangzj/lecun1-8x-2b-marks/
ModelsDir="../asserts/"
ModelsDir=$ModelsDir$ExperPath
mkdir -p $ModelsDir
# ../asserts/models/Pose/FLIC/liangzj/lecun1-8x-2b-marks/models/
model_path="models/"
model_path=$ModelsDir$model_path
mkdir -p $model_path
echo $model_path
# ../asserts/models/Pose/FLIC/liangzj/lecun1-8x-2b-marks/log/
log_path="log/"
