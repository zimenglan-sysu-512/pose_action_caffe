...
mkdir -p $ExperPath
# models/Pose/FLIC/black/lecun-8x-2b-sd5_5-tmarks_output_dependent/s1_solver.pt
...
mkdir -p $ModelsDir
# ../asserts/models/Pose/FLIC/black/lecun-8x-2b-sd5_5-tmarks_output_dependent/s1_models/
model_path="s1_models/"
model_path=$ModelsDir$model_path
mkdir -p $model_path
echo $model_path
# ../asserts/models/Pose/FLIC/black/lecun-8x-2b-sd5_5-tmarks_output_dependent/s1_log/
log_path="s1_log/"
