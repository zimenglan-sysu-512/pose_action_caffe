...
# models/Pose2/bbc/final/fusnet_tmask_2b_ft_1/
pt_dire="models/Pose2/"
sub_pt_dire="bbc/final/"
exper_name="fusnet_tmask_2b_ft_1/"
exper_path=$pt_dire$sub_pt_dire$exper_name
mkdir -p $exper_path

# models/Pose2/bbc/final/fusnet_tmask_2b_ft_1/solver.pt
solver_pt="solver.pt"
solver_pt=$exper_path$solver_pt
echo "\n" $solver_pt "\n"

# ../asserts/models/Pose2/bbc/final/fusnet_tmask_2b_ft_1/
model_dire="../asserts/"
model_dire=$model_dire$exper_path
mkdir -p $model_dire

# ../asserts/models/Pose2/bbc/final/fusnet_tmask_2b_ft_1/models/
model_path="models/"
model_path=$model_dire$model_path
mkdir -p $model_path
echo $model_path

# ../asserts/models/Pose2/bbc/final/fusnet_tmask_2b_ft_1/log/
log_path="log/"
...
if [ ! -n "$1" ] ;then
	re_iter=0
	resume_model_file="bbc_iter_"$re_iter".caffemodel"
else
	re_iter=$1
	resume_model_file="bbc_iter_"$re_iter".solverstate"
fi
