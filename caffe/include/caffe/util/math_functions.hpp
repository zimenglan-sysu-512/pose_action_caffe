...
template <typename Dtype>
void caffe_min(const int N, const Dtype* X, Dtype* Y);

template <typename Dtype>
void caffe_max(const int N, const Dtype* X, Dtype* Y);

template <typename Dtype>
void caffe_gpu_min(const int N, const Dtype* X, Dtype* Y);
...
void caffe_cpu_threshold(const int n, const Dtype threshold,
    const Dtype* x, Dtype* y, const bool is_binary = true);
