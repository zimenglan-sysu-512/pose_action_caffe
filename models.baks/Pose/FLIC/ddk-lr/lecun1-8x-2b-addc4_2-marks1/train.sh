...
# models/Pose/FLIC/ddk-lr/lecun1-8x-2b-addc4_2-marks1/
...
mkdir -p $ExperPath
# models/Pose/FLIC/ddk-lr/lecun1-8x-2b-addc4_2-marks1/solver.prototxt
solver_proto="solver.prototxt"
solver_proto=$ExperPath$solver_proto
echo $solver_proto
# ../asserts/models/Pose/FLIC/ddk-lr/lecun1-8x-2b-addc4_2-marks1/
ModelsDir="../asserts/"
ModelsDir=$ModelsDir$ExperPath
mkdir -p $ModelsDir
# ../asserts/models/Pose/FLIC/ddk-lr/lecun1-8x-2b-addc4_2-marks1/models/
model_path="models/"
model_path=$ModelsDir$model_path
mkdir -p $model_path
echo $model_path
# ../asserts/models/Pose/FLIC/ddk-lr/lecun1-8x-2b-addc4_2-marks1/log/
log_path="log/"
