...
# models/Pose/FLIC/black/lecun-8x-2b-sd5_5-tmarks_mid_c4_1/
ProtosDir="models/Pose/"
SubProtosDir="FLIC/black/"
ExperName="lecun-8x-2b-sd5_5-tmarks_mid_c4_1/"
ExperPath=$ProtosDir$SubProtosDir$ExperName
mkdir -p $ExperPath
# models/Pose/FLIC/black/lecun-8x-2b-sd5_5-tmarks_mid_c4_1/solver.prototxt
solver_proto="solver.prototxt"
solver_proto=$ExperPath$solver_proto
echo $solver_proto
# ../asserts/models/Pose/FLIC/black/lecun-8x-2b-sd5_5-tmarks_mid_c4_1/
ModelsDir="../asserts/"
ModelsDir=$ModelsDir$ExperPath
mkdir -p $ModelsDir
# ../asserts/models/Pose/FLIC/black/lecun-8x-2b-sd5_5-tmarks_mid_c4_1/models/
model_path="models/"
model_path=$ModelsDir$model_path
mkdir -p $model_path
echo $model_path
# ../asserts/models/Pose/FLIC/black/lecun-8x-2b-sd5_5-tmarks_mid_c4_1/log/
log_path="log/"
