...
# models/Pose/FLIC/ddk-lr/lecun1-8x-2b-addc4_2-sd5_5-marks1-refine1/
ProtosDir="models/Pose/"
SubProtosDir="FLIC/ddk-lr/"
ExperName="lecun1-8x-2b-addc4_2-sd5_5-marks1-refine1/"
ExperPath=$ProtosDir$SubProtosDir$ExperName
mkdir -p $ExperPath
# models/Pose/FLIC/ddk-lr/lecun1-8x-2b-addc4_2-sd5_5-marks1-refine1/solver.prototxt
solver_proto="solver.prototxt"
solver_proto=$ExperPath$solver_proto
echo $solver_proto
# ../asserts/models/Pose/FLIC/ddk-lr/lecun1-8x-2b-addc4_2-sd5_5-marks1-refine1/
ModelsDir="../asserts/"
ModelsDir=$ModelsDir$ExperPath
mkdir -p $ModelsDir
# ../asserts/models/Pose/FLIC/ddk-lr/lecun1-8x-2b-addc4_2-sd5_5-marks1-refine1/models/
model_path="models/"
model_path=$ModelsDir$model_path
mkdir -p $model_path
echo $model_path
# ../asserts/models/Pose/FLIC/ddk-lr/lecun1-8x-2b-addc4_2-sd5_5-marks1-refine1/log/
log_path="log/"
